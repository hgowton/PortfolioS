...
$(document).ready(function(){
    var projs = [
        { t: " ",
        d: "Plan and keep track of your day trips and vacations.  App allows user to select potential activities, places to visit, and restaurants to try. ",
        img: ["./assets/media/whereto.png", "./assets/media/whereto.png"],
        repo: "https://github.com/astrommen/WhereTo",
        actL: "https://where-to-planner.herokuapp.com/"},
        { t: " ",
